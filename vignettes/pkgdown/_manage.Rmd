...
To move or copy data from Radiant into R(studios)'s global workspace select `to global workspace` from the `Save data to type` dropdown and click the `Save` button.
